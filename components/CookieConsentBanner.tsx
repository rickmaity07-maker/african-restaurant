    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#0a0a0a] border-t border-amber-500/30 px-6 py-6 md:py-5">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <p className="text-xs md:text-sm text-stone-300 max-w-2xl">
          We use essential cookies to run this site (login sessions). With your
          consent we also load Google Maps, which transfers data to Google.
          See our{" "}
          <Link href="/datenschutz" className="text-amber-500 underline">
            privacy policy
          </Link>{" "}
          for details.
        </p>
